...
import {
  ArrowRight, Users, ShieldCheck, HeartHandshake, FileWarning, Flag, FileSearch,
...
const FaqSection = dynamic(() => import('@/components/FaqSection'), {
  loading: () => <div className="bg-white py-24" />,
});
      ...
      <section className="bg-white py-24" aria-label="Quiénes somos">
        <div className="container-om grid items-center gap-14 lg:grid-cols-2">
          <Reveal>
            ...
            <Link href="/hablamos-espanol" className="btn-outline mt-8">
      ...
      <section className="bg-mist py-24" aria-label="Nuestros servicios">
        <div className="container-om">
            ...
            {homeCategories.map((cat, i) => {
              ...
              return (
                <Reveal key={cat.name} delay={i * 90} className="h-full">
                  <Link
                    href={`/hablamos-espanol/${cat.slug}`}
          ...
          <Reveal className="mt-12 text-center">
            <Link href="/hablamos-espanol" className="btn-primary">
