...
import {
  ...
  FileCheck, FileText, BookOpen, Globe,
  Check, CalendarCheck,
} from 'lucide-react';
...
const communityServices = [
  { icon: Users, name: 'Procesos familiares', slug: 'peticion-familiar' },
  { icon: ShieldCheck, name: 'Asilo afirmativo', slug: 'asilo-afirmativo' },
  { icon: Scale, name: 'Asilo en corte', slug: 'asilo-en-corte' },
  { icon: HeartHandshake, name: 'VAWA', slug: 'vawa-i-360' },
  { icon: FileWarning, name: 'Visa U', slug: 'visa-u-i-918' },
  { icon: Globe2, name: 'TPS', slug: 'renovacion-tps' },
  { icon: Flag, name: 'Ciudadanía', slug: 'ciudadania-n-400' },
  { icon: IdCard, name: 'Residencia permanente', slug: 'renovacion-residencia' },
  { icon: Briefcase, name: 'Permisos de trabajo', slug: 'renovacion-permiso-trabajo' },
  { icon: FileSearch, name: 'FOIA', slug: 'solicitud-foia' },
  { icon: FileCheck, name: 'Ajuste de estatus', slug: 'ajuste-estatus' },
  { icon: FileCheck, name: 'Ajuste bajo VAWA', slug: 'ajuste-vawa' },
  { icon: HeartHandshake, name: 'Visa de prometido', slug: 'visa-prometido' },
  { icon: FileText, name: 'Exención provisional', slug: 'exencion-provisional' },
  { icon: FileCheck, name: 'Eliminación de condiciones', slug: 'eliminacion-condiciones' },
  { icon: BookOpen, name: 'DACA', slug: 'renovacion-daca' },
  { icon: Globe, name: 'Procesamiento consular', slug: 'procesamiento-consular' },
];
...
export default function HablamosEspanol() {
  ...
  const filtered = activeCategory === 'todas'
    ? communityServices
    : communityServices.filter((s) => {
        const svc = allServices.find((sv) => sv.slug === s.slug);
