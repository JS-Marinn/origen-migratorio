...
export function CTABand({
  ...
  return (
    <section className="relative overflow-hidden bg-gold" aria-label="Llamado a la acción">
      ...
      <svg
        className="pointer-events-none absolute -right-16 -top-24 h-[420px] w-[420px] opacity-10"
        viewBox="0 0 64 64"
        aria-hidden="true"
      >
        <circle cx="32" cy="32" r="30" fill="none" stroke="#313B5F" strokeWidth="1.5" />
        <path d="M20 42 V26 l8 9 8-9 v16" fill="none" stroke="#313B5F" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
      <div className="container-om relative py-20 text-center">
        <Reveal>
          ...
          <Link to="/contacto" className="btn-primary mt-8 !px-9 !py-4 text-base">
            {button}
...
export function GoldTicker() {
  const items = [
    'Procesos familiares', 'Asilo', 'VAWA', 'Visa U', 'TPS', 'Ciudadanía',
    'Residencia', 'Permisos de trabajo', 'FOIA', 'Corte de inmigración',
  ]
